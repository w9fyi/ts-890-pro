...
struct LOTWManager {
    ...
    private static func lotwDate(_ d: Date) -> String {
        let f = DateFormatter(); f.dateFormat = "yyyy-MM-dd"; f.timeZone = TimeZone(abbreviation: "UTC")!
        return f.string(from: d)
    }

    private static func lotwTime(_ d: Date) -> String {
