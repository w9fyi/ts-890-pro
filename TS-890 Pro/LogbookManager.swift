...
struct LogbookManager {
    ...
    // Cached UTC formatter — built once instead of per imported QSO.
    private static let adifImportFormatter: DateFormatter = {
    ...
    private static func parseADIFDateTime(date: String, time: String) -> Date? {
        ...
        return adifImportFormatter.date(from: d + timeComponent)
    }
