...
///   TS-590S: 000–087 (flat numbering)
...
enum KenwoodMenuDefinitions {
    ...
    static func getMenuCommand(for model: KenwoodRadioModel, menuNumber: Int) -> String {
        switch model {
        case .ts590s, .ts590sg:
            // TS-590S: EX{NNN}; — flat 3-digit numbering
            return String(format: "EX%03d;", menuNumber)
    ...
    static func setMenuCommand(for model: KenwoodRadioModel, menuNumber: Int, value: Int) -> String {
        switch model {
        case .ts590s, .ts590sg:
            // TS-590S: EX{NNN} {VVV}; — space separator, 3-digit value
            return String(format: "EX%03d %03d;", menuNumber, value)
