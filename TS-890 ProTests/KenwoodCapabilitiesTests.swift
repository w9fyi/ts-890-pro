...
final class KenwoodCapabilitiesTests: XCTestCase {
    private static let allModels: [KenwoodRadioModel] = [.ts590s, .ts590sg, .ts890s, .ts990s, .unknown]
    ...
    func testModelInit_ts990s_withPrefixAndSemicolon() {
        XCTAssertEqual(KenwoodRadioModel(idResponse: "ID022;"), .ts990s)
    }
    ...
    func testTS590SG_has18BandEQ() {
        XCTAssertTrue(caps(.ts590sg).has18BandEQ, "TS-590S/SG support the UT/UR 18-band EQ commands")
    }
